...
export default function Footer() {
  ...
  const whatsappNumber = settings.whatsappNumber || '15618538703'
  const whatsappNumber2 = import.meta.env.VITE_WHATSAPP_NUMBER_2 || '15618534450'
  const whatsappUrl = `https://wa.me/${whatsappNumber}`
  const whatsappUrl2 = `https://wa.me/${whatsappNumber2}`

  return (
    <footer className="bg-dark text-textLight">
